...
const setData = (data) => {
  let { Pid,projectName, startDate, startDate1,projectManager,status  } = data;
...
const onDelete = (Pid) => {
axios.delete(`https://6260010f53a42eaa07fea4af.mockapi.io/application/${Pid}`)
.then(() => {
getData();
})
}
...
const [Pid, setPid] = useState([])
    ...
    const fetchData = () => {
      fetch("https://6260010f53a42eaa07fea4af.mockapi.io/application")
        .then(response => {
            ...
            {searchInput.length > 1 ? (
                 ...
                 <OverlayTrigger className="edit " overlay={<Tooltip id="tooltip-disabled">Chart</Tooltip>}>
                    ...
                    <OverlayTrigger overlay={<Tooltip id="tooltip-disabled">Delete</Tooltip>}>
                      <a style={{cursor:"pointer"}}><RiDeleteBin5Line className="edit m-1" onClick={()=>{handleShow(data.Pid)}} size={30} color="gray"/></a>
                     </OverlayTrigger>
                    </td>
                          </tr>
                        )
             ...
             APIData.length>0?
                ...
                (
                 ...
                 <OverlayTrigger className="edit" overlay={<Tooltip id="tooltip-disabled">Chart</Tooltip>}>
                    ...
                    <OverlayTrigger overlay={<Tooltip id="tooltip-disabled">Delete</Tooltip>}>
                      <a style={{cursor:"pointer"}}><RiDeleteBin5Line className="edit me-2" onClick={()=>{handleShow(data.Pid)}} size={30} color="gray"/></a>
                     </OverlayTrigger>
