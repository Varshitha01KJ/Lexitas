...
//  const [pid,setPid]=useState();
                  ...
                  <div className="row pb-2">
                   ...
                   <input type="text" className="form-control rounded-0 outline" value={projectName} onChange={(e)=>setProjectName(e.target.value)}/>
                    ...
                    <div className="input-group date" >
                      ...
                      {/* <Moment format="YYYY/MM/DD" onChange={e=>setEndDates(e.target.value)}>
                1976-04-19T12:59-0500
            </Moment> */}
                      {/* <DatePicker selected={enddate} onChange={e=>setEndDates(e.target.value)} /> */}
                  </div>
                        </div>
                      ...
                      <div className="row  ">
                        ...
                        <div className="col-4 ">
                            <label  className="form-label">Project Members</label>
                             <Select type="text" className=' '  onChange={setSelectedOption} options={options} isMulti={options} />
 ...
 {<p className='text-danger'> {errors}</p>}
                    <div className="row pb-3">
                      <div className=" d-flex justify-content-end pt-3  pe-3 ps-5 ms-5">
