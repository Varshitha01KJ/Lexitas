...
//      useEffect ( () => {
//       axios.get(`https://6260010f53a42eaa07fea4af.mockapi.io/application/${pdata.Pid}`)
...
const [errors1,setError1]=useState('');
  const [submitted1, setSubmitted1] = useState(false);
   ...
   const postData1 = (e) => {
    ...
    axios.post(`https://6260010f53a42eaa07fea4af.mockapi.io/task`, {
  // Pid:pdata.id, 
     taskName,
      start,
      start1,
          ...
          <div className="mx-5 ">
            <div className="pt-4 ps-1  row pb-3">
                <div className="col d-flex justify-content-between">
                  ...
                  <h5 className="fw-normal ">Add Task for Project <span class="fw-bolder">{projectName}  </span></h5>
            ...
            <div className="row   gap-1 pb-2">
              <div className="col-5 ">
                  <form>
                    ...
                    <input type="text" class="form-control rounded-0 outline" onChange={(e)=>setTaskName(e.target.value)}></input>
            </form>
            </div>
            ...
            <div className="col Date ">
                <label  className="form-label ms-2">Start Date</label>
                    <div className="input-group date " id="outlines">
                      <input type="date" className="form-control rounded-0 pt-2 input-group  outline  px-1" placeholder="DD-MM-YYYY" id="outlines" onChange={e=>setStart(e.target.value)}/>
                    </div>
              </div>
              <div className="col ">
                <label  className="form-label">End Date</label>
                    <div className="input-group date" >
                      <input type="date" className="form-control rounded-0 pt-2 ms-1 pe-1 input-group border outline pt-1 px-1" placeholder="DD-MM-YYYY" onChange={e=>setStart1(e.target.value)}/>
            ...
            <div className="col ">
                ...
                <select className="form-select rounded-0 ms-2 pe-5" onChange={(e)=>setStatus(e.target.value)}>
              ...
              <div className="row    pb-2">
                <div className="col-2 me-1">
                    ...
                    <select className="form-select rounded-0 border-none" aria-label="Default select example" id="task" onChange={(e)=>setTaskOwner(e.target.value)}>
                  ...
                  <div className="col-2 ms-5 ">
                    ...
                    <select className="form-select rounded-0 border-none" aria-label="Default select example" id="task" onChange={(e)=>setPriority(e.target.value)}>
                      <option selected> Jacob</option>
              ...
              <div className="col ps-3 ms-5 ">
                ...
                <textarea type="text" class="form-control pb-5 ms-2  rounded-0 " onChange={(e)=>setDescription(e.target.value)} ></textarea>
            </div>
          </div>
                    
                <div className="row pb-5">
                    <div className=" d-flex justify-content-end pt-3  pe-2 ps-5 ms-5">
                    <button className="btn  bg-warning ms-2 me-2 text-white rounded-0" type="button" onClick={postData1}><FaRegSave className="me-2" size={20}></FaRegSave>SAVE</button>
                 <NavLink to={`/ProjectManagement/${id}`}>   <button className="btn  bg-warning ms-2 me-5 text-white rounded-0" type="button" ><AiOutlinePlus className=" me-2" size={20}></AiOutlinePlus>SAVE & ADD NEW TASK</button></NavLink>
                </div> 
...
<Modal show={show1} onHide={handleClose1}>
                      ...
                      <Modal.Footer>
                      <NavLink to='/'>   <a> <Button id="yes" onClick={handleClose1}>
                        Yes
                        </Button></a>
                        </NavLink>
